...
if(jQuery('#lineChart_3Kk_1').length > 0 ){
    ...
    const lineChart_3Kk = document.getElementById("lineChart_3Kk_1").getContext('2d');
    //generate gradient
    const lineChart_3gradientStroke1 = lineChart_3Kk.createLinearGradient(500, 0, 100, 0);
    lineChart_3gradientStroke1.addColorStop(0, "rgba(26, 51, 213, 1)");
    lineChart_3gradientStroke1.addColorStop(1, "rgba(26, 51, 213, 0.5)");
...
if(jQuery('#lineChart_3Kk_2').length > 0 ){
    ...
    const lineChart_3Kk = document.getElementById("lineChart_3Kk_2").getContext('2d');
    //generate gradient
    const lineChart_3gradientStroke1 = lineChart_3Kk.createLinearGradient(500, 0, 100, 0);
    lineChart_3gradientStroke1.addColorStop(0, "rgba(26, 51, 213, 1)");
    lineChart_3gradientStroke1.addColorStop(1, "rgba(26, 51, 213, 0.5)");
