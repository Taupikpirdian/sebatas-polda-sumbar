  ...
  <div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
      <div class="welcome-text">
        <h4>Data Semua Kecelakaan lalu-lintas </h4>
      </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{URL::to('/total-laka-lantas')}}">Data Semua Kecelakaan lalu-lintas</a>
        </li>
      </ol>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        ...
        <a title="Tambah data Laka Lantas" href="{{URL::to('/laka-lantas/create')}}" class="btn btn-sm btn-info float-left"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
          {!! Form::open(['method'=>'GET','url'=>'total-laka-lantas','role'=>'search'])  !!}
            <div class="input-group" style="float: left; width: 300px; margin-right: 10px">
              <input type="text" class="form-control float-left" name="search" value="{{ $search_bar }}" placeholder="Search no LP atau korban ...">
