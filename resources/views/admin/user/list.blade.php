    ...
    <div class="col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header">
                <a title="Tambah data" style="float: left; margin-right: 10px" href="{{URL::to('/user/create')}}" class="btn btn-sm btn-info float-left"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
              </div>
                <div class="card-body">
