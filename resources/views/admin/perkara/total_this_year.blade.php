  ...
  <div class="row page-titles mx-0">
    <div class="col-sm-6 p-md-0">
      <div class="welcome-text">
        <h4>Data Semua Perkara Tahun {{ now()->year }} </h4>
      </div>
    </div>
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{URL::to('/total-crime-this-year')}}">Data Semua Perkara tahun 2021</a>
        </li>
      </ol>
    </div>
  </div>
    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-header">
          {!! Form::open(['method'=>'GET','url'=>'/total-crime-this-year','role'=>'search'])  !!}
