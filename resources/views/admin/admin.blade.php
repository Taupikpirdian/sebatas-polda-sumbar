...
<div class="container-fluid">
  <div class="row">
    <div class="col-xl-9 col-xxl-12">
      <div class="row">
        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
          <div class="card overflow-hidden">
            <div class="card-body pb-0 px-4 pt-4">
              <div class="row">
                <div class="col">
                  <h5 class="mb-1">{{ $count_kasus }}</h5>  <span class="text-success">Total Kejahatan</span><br>
                  <a href="{{URL::to('/total-crime')}}">Lihat Detail</a>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
          <div class="card bg-success	overflow-hidden">
            <div class="card-body pb-0 px-4 pt-4">
              <div class="row">
                <div class="col">
                  <h5 class="text-white mb-1">{{ $count_kasus_lama }}</h5>  <span class="text-white">Perkara Tunggakan</span><br>
                  <a href="{{URL::to('/perkara-lama')}}">Lihat Detail</a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pb-0 px-4 pt-4">
              <div class="row">
                <div class="col text-white">
                  <h5 class="text-white mb-1">{{ $count_kasus_this_y }}</h5>  <span>Total Kejahatan Tahun 2021</span><br>
                  <a href="{{URL::to('/total-crime-this-year')}}" class="text-danger">Lihat Detail</a>
                </div>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-xxl-3 col-lg-6 col-sm-6">
          <div class="card overflow-hidden">
            <div class="card-body px-4 py-4">
              <h5 class="mb-3">{{ $count_kasus }} <small class="text-primary">Kejahatan</small></h5>
              ...
              <div id="DZ_W_TimeLine1" class="widget-timeline dz-scroll style-1" style="height:250px;">
                ...
                <!-- kode = 1 -->
                  <li>
                    ...
                    <a class="timeline-panel text-muted" href="#">{{ $log->name }}<span>{{ $log->age_of_data }}</span>
                      <h6 class="mb-0">Menambahkan data Kejahatan</h6> 
                ...
                <!-- kode = 2 -->
                  <li>
                    ...
                    <a class="timeline-panel text-muted" href="#">{{ $log->name }}<span>{{ $log->age_of_data }}</span>
                      <h6 class="mb-0">Update status Kejahatan</h6>
                      <p class="mb-0">{{ $log->no_lp }}</p>
                    </a>
                  </li>
                @elseif($log->status == 3)
                <!-- kode = 3 -->
                  <li>
                    ...
                    <a class="timeline-panel text-muted" href="#">{{ $log->name }}<span>{{ $log->age_of_data }}</span>
                      <h6 class="mb-0">Edit data Kejahatan</h6> 
                      <p class="mb-0">{{ $log->no_lp }}</p>
                    </a>
                  </li>
                @elseif($log->status == 4)
                <!-- kode = 4 -->
                  <li>
                    ...
                    <a class="timeline-panel text-muted" href="#">{{ $log->name }}<span>{{ $log->age_of_data }}</span>
                      <h6 class="mb-0">Update anggaran Kejahatan</h6> 
                      <p class="mb-0">{{ $log->no_lp }}</p>
                    </a>
                  </li>
                @endif
        ...
        <div class="col-xl-8 col-xxl-8 col-lg-12 col-md-12">
          <div class="card">
            <div class="card-header border-0 pb-0">
              <h4 class="card-title">Data Kejahatan Terbaru</h4>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-responsive-sm mb-0">
                  ...
                  @foreach($perkaras as $key=>$perkara)
                    <tr>
                      <td><b>{{ $perkara->no_lp }}</b></td>
                      <td>{{ $perkara->satuan }}</td>
                      <td>{{ $perkara->pidana }}</td>
                      <td>{{ \Carbon\Carbon::parse($perkara->date)->format('j F, Y') }}</td>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
    ...
    <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
      <div class="card bg-primary text-white">
        <div class="card-header pb-0 border-0">
          <h4 class="card-title text-white">Kejahatan Index <label style="font-size: 12px; color: #72A0FE">berdasarkan jenis Kejahatan</label></h4>
        </div>
        <div class="card-body">
              ...
              <li>
                <div class="timeline-panel">
                  <div class="media-body">
                    <h5 style="font-size: 14px" class="mb-1 text-white">{{ $top->name }}</h5>  <small class="d-block">{{ $top->total }} Kejahatan</small>
                  </div>
                </div>
              </li>
              @endforeach
    ...
    <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
      <div class="card bg-primary text-white">
        <div class="card-header pb-0 border-0">
          <h4 class="card-title text-white">Kejahatan Index <label style="font-size: 12px; color: #72A0FE">berdasarkan satker</label></h4>
        </div>
        <div class="card-body">
          <div class="widget-media">
            <ul class="timeline">
              <li>
                <div class="timeline-panel">
                  <div class="media-body">
                    ...
                    <small class="d-block">{{ $key + 1 }}. {{ $top_polda->name }} <label style="font-size: 12px; color: #72A0FE">({{$top_polda->total}} Kejahatan)</label></small>
                    @endforeach
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="timeline-panel">
                  <div class="media-body">
                    ...
                    <small class="d-block">{{ $key + 1 }}. {{ $top_polres->name }} <label style="font-size: 12px; color: #72A0FE">({{$top_polres->total}} Kejahatan)</label></small>
                    @endforeach
                  </div>
                </div>
              </li>
              ...
              <li>
                <div class="timeline-panel">
                  <div class="media-body">
                    ...
                    <small class="d-block">{{ $key + 1 }}. {{ $top_polsek->name }} <label style="font-size: 12px; color: #72A0FE">({{$top_polsek->total}} Kejahatan)</label></small>
                    @endforeach
                  </div>
                </div>
              </li>
        ...
        <div class="card-body">
            <div class="basic-form">
                <div class="row">
                    ...
                    <div class="col-sm-6 mt-2 mt-sm-0" style="margin-bottom: 12px">
                      <select name="bulan" id="month-select2">
        ...
        <div class="card-body">
            <div class="basic-form">
                <div class="row">
                    ...
                    <div class="col-sm-3" style="margin-bottom: 12px">
                        Bulan: <b>@if($bulan_param){{ $month[$bulan_param] }} @else - @endif</b>
                    </div>
                    <div class="col-sm-3" style="margin-bottom: 12px">
        ...
        <div class="card-body p-4">
          <div class="media ai-icon">	
            ...
            <div class="media-body">
              ...
              <h4 class="mb-0">{{ ceil($resiko_terkena_pidana) }}</h4>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body p-4">
          <div class="media ai-icon">	
            ...
            <div class="media-body">
              ...
              <h4 class="mb-0">{{ $bulat_selang_waktu }}</h4>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- <div class="col-xl-4 col-lg-6 col-sm-6">
      <div class="widget-stat card">
        <div class="card-body p-4">
          ...
          <h3 style="color: #3A7AFE">{{ ceil($persentase_perkembangan_jumlah_kejahatan) }}%</h3>
        </div>
      </div>
    </div> -->
    <div class="col-xl-4 col-lg-6 col-sm-6">
      <div class="widget-stat card">
        <div class="card-body p-4">
          ...
          <h3 style="color: #3A7AFE">{{ ceil($percent_done_f_map) }}%</h3>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
      <div class="card bg-success text-white">
        <div class="card-header pb-0 border-0">
          <h4 class="card-title text-white">Kejahatan Index <label style="font-size: 12px; color: #EBEEF6">berdasarkan jenis Kejahatan</label></h4>
        </div>
        <div class="card-body">
          <div class="widget-media">
            <ul class="timeline">
    ...
    <div class="col-xl-3 col-xxl-4 col-lg-12 col-md-12">
      <div class="card bg-success text-white">
        <div class="card-header pb-0 border-0">
          <h4 class="card-title text-white">Kejahatan Index <label style="font-size: 12px; color: #EBEEF6">berdasarkan satker</label></h4>
        </div>
        <div class="card-body">
          <div class="widget-media">
            <ul class="timeline">
    ...
    <div class="col-xl-12 col-xxl-12 col-lg-12 col-md-12">
      ...
      <div class="card">
        <div class="card-header">
          <h5 class="card-title">Peta Persebaran Kriminal Provinsi Sumatera Barat Tahun {{ $tahun_param }}</h5>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <div class="row">
          ...
          <div class="row">
            <div class="col-sm-3 col-6">
              <div class="description-block border-right">
                ...
                <span style="text-decoration:none;" class="description-text">Total Kejahatan</span>
              </div>
              <!-- /.description-block -->
            </div>
            <!-- /.col -->
            <div class="col-sm-3 col-6">
              <div class="description-block border-right">
                ...
                <a style="text-decoration:none;" href="{{URL::to('/perkara/done?satker='.$satker_param.'&jenis_kasus='.$jenis_kasus_param.'&tahun='.$tahun_param)}}" target="_blank"><span class="description-text">Kejahatan Selesai <span style="font-size: 12px; color: #72A0FE;text-decoration:none;">klik here for detail</span></span></a>
              </div>
              <!-- /.description-block -->
            </div>
            <!-- /.col -->
            <div class="col-sm-3 col-6">
              <div class="description-block border-right">
                ...
                <a style="text-decoration:none;" href="{{URL::to('/perkara/progress?satker='.$satker_param.'&jenis_kasus='.$jenis_kasus_param.'&tahun='.$tahun_param)}}" target="_blank"><span class="description-text">Kejahatan Progress <span style="font-size: 12px; color: #72A0FE;text-decoration:none;">klik here for detail</span></span></a>
              </div>
              <!-- /.description-block -->
            </div>
            <!-- /.col -->
            <div class="col-sm-3 col-6">
              <div class="description-block">
                ...
                @endif
                <span style="text-decoration:none;" class="description-text">Persentase Kejahatan Selesai</span>
              </div>
              <!-- /.description-block -->
            </div>
          </div>
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Kejahatan Data Tahun {{ $tahun_param }}</h4>
        </div>
        <div class="card-body">
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Insiden Kejahatan Data <label style="font-size: 12px; color: #72A0FE">berdasarkan waktu</label></h4>
        </div>
        <div class="card-body">
