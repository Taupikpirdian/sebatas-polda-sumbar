    ...
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">User Group</a></li>
            </ol>
        </div>
    </div>
    <!-- row -->
    ...
    <div class="col-lg-12 col-md-12">
            <div class="card">
              <div class="card-header">
                <a title="Tambah data" style="float: left; margin-right: 10px" href="{{URL::to('/user-groups/create')}}" class="btn btn-sm btn-info float-left"><i class="fa fa-plus-circle" aria-hidden="true"></i> Tambah Data</a>
              </div>
                <div class="card-body">
