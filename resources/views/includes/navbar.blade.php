        ...
        <ul class="navbar-nav header-right">
          ...
          <li class="nav-item dropdown header-profile">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown">
              <div class="header-info"> <span>Hey, <strong>@if(Auth::check()) {{ Auth::user()->name }} @endif</strong></span>  <small>{{ Auth::user()->divisi }}</small>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-right">
              <a href="{{URL::to('/ubah-password')}}" class="dropdown-item ai-icon">
...
<div class="deznav">
  <div class="deznav-scroll">
    <ul class="nav menu-tabs">
      ...
      @if(Auth::user()->groups()->where("name", "=", "Admin")->first() || Auth::user()->groups()->where("name", "=", "Polres")->first())
      <li class="nav-item">
